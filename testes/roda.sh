...
falhou=0
for t in geo.test pos.test emenda.test pdf.test cor.test grafico.test estante.test tela posicao guias traco laco letra ajuste imagem grafico fio teto cota; do
